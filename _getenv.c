...
char *_getenv(const char *name)
{
    ...
    environ_copy = NULL;
    environ_copy = copy_en(environ_copy, environ_length);
...
/**
 * copy_env - copies enviroment variable
 * @environ_copy: pointer to copy of enviroment variable
 * @environ_length: length of envirnmment variable
 * 
...
{
    char *variable;
    unsigned int variable_length, i;
